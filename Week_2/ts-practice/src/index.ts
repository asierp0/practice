...
// TYPE STRING LITERALS (could also use enum here)
...
// ESCALATED TICKET & INTERSECTIONS
...
type EscalatedTicket = Ticket & Escalation;

const escalatedTicket: EscalatedTicket = {
    id: 4,
...
function checkEscalatedTicket(ticket: Ticket): ticket is EscalatedTicket{
...
function unknownTypeExample(unknownData: unknown): void{
...
function neverTypeExample(message:string): never{
...
const personAgent = person as Agent;
